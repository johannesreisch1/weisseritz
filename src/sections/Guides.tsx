...
// TODO audios
const audioFiles = [audio7, audio7, audio7, audio7, audio7, audio7, audio7, audio7, audio7, audio7];
      ...
      <Box sx={{ width: '80%', mx: 'auto', mb: 5 }}>
        ...
        {stations.map((station) => (
          <Accordion
            ...
            expanded={expanded == station.id && !station.disabled}
            onChange={(_, isExpanded) => setExpanded(isExpanded ? station.id : false)}
          >
